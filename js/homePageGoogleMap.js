...
$("#navBtn1").on("click", (event) => {
  if (directionsService1 == null || directionsRenderer1 == null) return;
...
$("#navBtn2").on("click", (event) => {
  if (directionsService2 == null || directionsRenderer2 == null) return;
  var buttonText = $(event.target).text();
  if (buttonText === "導航") {
    updateMap_2();
    $(event.target).text("切換");
...
$("#navBtn3").on("click", (event) => {
  if (directionsService3 == null || directionsRenderer3 == null) return;
